    ...
    */
    ...
    public function map($row): array
    {
        ...
        return [
            ...
            $row->pot_size_a,
            (($row->inventory_count_a==0)?0:$row->inventory_count_a),
            (($row->low_inventory_count_a==0)?0:$row->low_inventory_count_a),
            ...
            $row->pot_size_b,
            (!empty($row->inventory_count_b)?0:0),
            (!empty($row->low_inventory_count_b)?0:0),
            ...
            $row->pot_size_c,
            ($row->inventory_count_c?$row->inventory_count_c:0),
            ($row->low_inventory_count_c?$row->low_inventory_count_c:0),

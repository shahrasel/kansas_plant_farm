...
class CreateProductsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->text('contractor_price_a');
            $table->text('retail_sale_price_a');
            $table->text('retail_list_price_a');
            ...
            $table->text('contractor_price_b');
            $table->text('retail_sale_price_b');
            $table->text('retail_list_price_b');
            ...
            $table->text('contractor_price_c');
            $table->text('retail_sale_price_c');
            $table->text('retail_list_price_c');

...
class UpdateSettingsAdditionalAboutUsFeilds extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('setting_additionals', function (Blueprint $table) {
            $table->longText('about_who_we_are')->after('our_gurantee')->nullable();

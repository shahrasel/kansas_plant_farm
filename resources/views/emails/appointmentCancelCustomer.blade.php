                            ...
                            <!-- Body content --><tr>
                                <td class="content-cell" style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; max-width: 100vw; padding: 32px;">
                                    ...
                                    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        ...
                                        Hi {{ $appointment->firstname }},<br/><br/>

                                        We are sorry to hear you had to cancel your appointment. If your cancellation is the same day as when you made the appointment, please text us at 785-218-7475.<br/><br/>

                                        The following Date & Time has been removed from our calendar:<br/><br/>

                                        Previous Appointment Date: {{ date('l, F j',strtotime($appointment->date)) }}<br/>
                                        Previous Appointment Time: {{ $appointment->time }}<br/><br/>

                                        We hope to reschedule another visit soon!

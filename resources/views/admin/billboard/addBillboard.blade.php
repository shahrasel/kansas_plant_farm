                    ...
                    <div class="col-lg-12">
                        <div class="element-wrapper">
                            <div class="element-box">
                                <form action="{{ url('/admin/billboards') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <fieldset class="form-group">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" placeholder="Enter heading" type="text" name="heading" value="{{ old('heading') }}" >
                                                @error('heading')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" placeholder="Enter Sub-heading" type="text" name="subheading" value="{{ old('subheading') }}" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" placeholder="Enter button text" type="text" name="button_text" value="{{ old('button_text') }}" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" placeholder="Enter button URL" type="text" name="button_url" value="{{ old('button_url') }}" >
                                            </div>
                                        </div>

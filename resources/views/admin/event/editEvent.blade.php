                                ...
                                <form action="{{ url('/admin/events/'.$event->id) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <fieldset class="form-group">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" placeholder="Enter title" type="text" name="name" value="{{ $event->name }}" required>
                                                @error('name')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="ckeditor form-control" name="description" id="description">{{ $event->description }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                @if(!empty($event->image))
                                                    <img src="{{ asset('img/event/'.$event->image) }}" style="width: 100px;"><br/><br/>
                                                @endif

                    ...
                    <div class="col-lg-12">
                        <div class="element-wrapper">
                            <div class="element-box">
                                <form action="{{ url('/admin/garden-themes/'.$garden_theme->id) }}" method="post">
                                    @method('PUT')
                                    @csrf
                                    ...
                                    <fieldset class="form-group">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" placeholder="Enter title" type="text" name="title" value="{{ $garden_theme->title }}" required>
                                                @error('title')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <textarea class="ckeditor form-control" name="description" id="description">{{ $garden_theme->description }}</textarea>
...
<!--                                    <input type="hidden" name="id" value="">-->
                                ...
                                <fieldset class="form-group">
                                        ...
                                        <form action="{{ route('garden-theme-image-processor', ['id' => $garden_theme->id]) }}" class="dropzone" id="my-dropzone">
                                            @csrf
...
@section('javascript')
    ...
    <script>
        ...
        Dropzone.options.myDropzone = {
            ...
            init: function() {
                thisDropzone = this;
                jQuery.get("{{ route('garden-theme-image-processor', ['id'=>$garden_theme->id]) }}", function(data) {
                    //alert(jQuery.type(data));
                    jQuery.each(data, function(key,value){

                        var mockFile = { name: value.name, size: value.size, src: value.src };
                        thisDropzone.options.addedfile.call(thisDropzone, mockFile);
                        thisDropzone.options.thumbnail.call(thisDropzone, mockFile, "{{ url('img/garden_theme/thumb') }}/{{ $garden_theme->id }}/"+value.name);
                    });
                });
            }
        };
            ...
            jQuery('.dropzone').sortable({
                ...
                stop: function (event, ui) {
                    ...
                    jQuery.ajax({
                        type: 'POST',
                        url: '{{ route('garden-theme-image-processor', ['id'=>$garden_theme->id]) }}',
                        data: 'fn='+data+'&ac=sorting'+'&pid={{ $garden_theme->id }}&_token={{csrf_token()}}',

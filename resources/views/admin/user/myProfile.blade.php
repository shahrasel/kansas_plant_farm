...
<!--                                    <div class="form-desc">
                                    ...
                                    <fieldset class="form-group">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" placeholder="Enter first name" type="text" name="firstname" value="{{ auth()->user()->firstname }}" required>
                                                @error('firstname')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" placeholder="Enter last name" type="text" name="lastname" value="{{ auth()->user()->lastname }}" required>
                                                @error('lastname')
                                                <p style="color: #ff0000">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" placeholder="Enter email" type="email" name="email" value="{{ auth()->user()->email }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" placeholder="Enter phone" type="phone" name="phone" value="{{ auth()->user()->phone }}">
                                                @error('phone')
                                                <p style="color: #ff0000">{{ $message }}</p>
                                                @enderror
                                            </div>
                                    ...
                                    <fieldset class="form-group">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" placeholder="Enter City" type="text" name="city" value="{{ auth()->user()->city }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" placeholder="Enter Zip" type="text" name="zip" value="{{ auth()->user()->zip }}">
                                                @error('zip')
                                                <p style="color: #ff0000">{{ $message }}</p>
                                                @enderror
                                            </div>
                                    ...
                                    <fieldset class="form-group">
                                        <legend><span>Upload Photo</span></legend>
                                        <div class="form-group row">
                                            <label class="col-form-label col-sm-4" for=""> Upload Photo</label>
                                            <div class="col-sm-8">
                                                @if(auth()->user()->pimage)
                                                    <p>
                                                        <img src="{{ asset('img/users/'.auth()->user()->pimage) }}" style="width: 100px;"><br/><br/>
                                                    </p>
                                                @endif

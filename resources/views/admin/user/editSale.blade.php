...
<!--                            <h6 class="element-header">
                            ...
                            <div class="element-box">
                                <form action="{{ url('/admin/sales/update') }}" method="post">
                                    @csrf
                                    @method('put')
                                    <h5 class="form-header">
                                        Edit Sales Agent
...
<!--                                    <div class="form-desc">
                                    ...
                                    <fieldset class="form-group">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" placeholder="Enter first name" type="text" name="firstname" value="{{ $sales_info->firstname }}" required>
                                                @error('firstname')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" placeholder="Enter last name" type="text" name="lastname" value="{{ $sales_info->lastname }}" required>
                                                @error('lastname')
                                                <p style="color: #ff0000">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" placeholder="Enter email" type="email" name="email" value="{{ $sales_info->email }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" placeholder="Enter phone" type="phone" name="phone" value="{{ $sales_info->phone }}">
                                                @error('phone')
                                                <p style="color: #ff0000">{{ $message }}</p>
                                                @enderror
                                            </div>
                                    ...
                                    <fieldset class="form-group">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" placeholder="Enter Company Name" type="text" name="company" value="{{ $sales_info->company_name }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" placeholder="Enter Address 1" type="text" name="address1" value="{{ $sales_info->address1 }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" placeholder="Enter Address 2" type="text" name="address2" value="{{ $sales_info->address2 }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" placeholder="Enter City" type="text" name="city" value="{{ $sales_info->city }}">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-control" name="state">
                                                    ...
                                                    @foreach(stateList() as $key=>$state)
                                                        <option value="{{ $key }}" {{ $sales_info->state == $key ? 'selected' : '' }}> {{ $state }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" placeholder="Enter Zip" type="text" name="zip" value="{{ $sales_info->zip }}">
                                                @error('zip')
                                                <p style="color: #ff0000">{{ $message }}</p>
                                                @enderror
                                            </div>

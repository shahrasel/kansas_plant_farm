                      ...
                      ------------------  -->
                                <div class="table-responsive">
                                    <table class="table table-bordered table-lg table-v2 table-striped">
                                        <thead>
                                        <tr>                                            <th>Name</th><th>Email</th><th>Price</th><th>Status</th><th>Created</th><th>Details</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        @forelse($new_order_lists as $order_list)
                                            <tr>
                      ...
                      ------------------  -->
                                <div class="table-responsive">
                                    <table class="table table-bordered table-lg table-v2 table-striped">
                                        ...
                                        <tbody>
                                        @forelse($completed_order_lists as $order_list)
                                            <tr>
                                                <td>{{ $order_list->firstname }} {{ $order_list->lastname }}</td>
                                                <td>{{ $order_list->email }}</td>
                                                <td>${{ $order_list->total_price }}</td>

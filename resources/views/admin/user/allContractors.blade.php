...
<!--                        <div class="form-desc">
                        ...
                        <div class="table-responsive">
                            <table id="dataTable10" width="100%" class="table table-striped table-lightfont">
                                ...
                                <tbody>
                                    @forelse($contractor_lists as $contractor_list)
                                        <tr>
                                            <td>{{ $contractor_list->firstname }} {{ $contractor_list->lastname }}</td>
                                            <td>{{ $contractor_list->email }}</td>
                                            <td>{{ $contractor_list->phone }}</td>
                                            <td>{{ $contractor_list->address1 }} {{ $contractor_list->city }} {{ $contractor_list->state }} {{ $contractor_list->zip }}</td>
                                            <td>{{ $contractor_list->created_at }}</td>
                                        </tr>
                                    @empty
                                            <tr>

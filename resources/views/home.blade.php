                ...
                <div class="row row-20 mtn-20">
                    <div class="col-sm-6">
                        <figure class="banner-statistics mt-20">
                            <a href="#">
                                <img src="{{ asset('img/banner/img1-top.jpg')  }}" alt="product banner">
                            </a>
                    ...
                    <div class="col-sm-6">
                        <figure class="banner-statistics mt-20">
                            <a href="#">
                                <img src="{{ asset('img/banner/img2-top.jpg')  }}" alt="product banner">
                            </a>
                    ...
                    <div class="col-sm-6">
                        <figure class="banner-statistics mt-20">
                            <a href="#">
                                <img src="{{ asset('img/banner/img3-top.jpg')  }}" alt="product banner">
                            </a>
                            <div class="banner-content text-center">
                    ...
                    <div class="col-sm-6">
                        <figure class="banner-statistics mt-20">
                            <a href="#">
                                <img src="{{ asset('img/banner/img4-middle.jpg')  }}" alt="product banner">
                            </a>
                            <div class="banner-content text-right">
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="product-details.html">
                                                    ...
                                                    <img class="sec-img" src="{{ asset('img/product/product-18.jpg')  }}" alt="product">
                                                </a>
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="product-details.html">
                                                    ...
                                                    <img class="sec-img" src="{{ asset('img/product/product-17.jpg')  }}" alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                                        <span>sale</span>
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="product-details.html">
                                                    ...
                                                    <img class="sec-img" src="{{ asset('img/product/product-16.jpg')  }}" alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                                        <span>new</span>
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="product-details.html">
                                                    ...
                                                    <img class="sec-img" src="{{ asset('img/product/product-15.jpg')  }}" alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                                        <span>sale</span>
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="product-details.html">
                                                    ...
                                                    <img class="sec-img" src="{{ asset('img/product/product-14.jpg')  }}" alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                                        <span>new</span>
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="product-details.html">
                                                    ...
                                                    <img class="sec-img" src="{{ asset('img/product/product-13.jpg')  }}" alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                                        <span>new</span>
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="product-details.html">
                                                    ...
                                                    <img class="sec-img" src="{{ asset('img/product/product-11.jpg')  }}" alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                                        <span>new</span>
                                ...
                                <div class="tab-pane fade" id="tab4">
                                    <div class="product-carousel-4 slick-row-10 slick-arrow-style">
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="product-details.html">
                                                    <img class="pri-img" src="{{ asset('img/product/product-16.jpg')  }}" alt="product">
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="product-details.html">
                                                    <img class="pri-img" src="{{ asset('img/product/product-17.jpg')  }}" alt="product">
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="product-details.html">
                                                    <img class="pri-img" src="{{ asset('img/product/product-18.jpg')  }}" alt="product">
                        ...
                        <div class="product-banner-carousel slick-row-10">
                            ...
                            <div class="banner-slide-item">
                                <figure class="banner-statistics">
                                    <a href="#">
                                        <img src="{{ asset('img/banner/img1-middle.jpg')  }}" alt="product banner">
                                    </a>
                            ...
                            <div class="banner-slide-item">
                                <figure class="banner-statistics">
                                    <a href="#">
                                        <img src="{{ asset('img/banner/img2-middle.jpg')  }}" alt="product banner">
                                    </a>
                                    <div class="banner-content banner-content_style2">
                            ...
                            <div class="banner-slide-item">
                                <figure class="banner-statistics">
                                    <a href="#">
                                        <img src="{{ asset('img/banner/img3-middle.jpg')  }}" alt="product banner">
                                    </a>
                                    <div class="banner-content banner-content_style2">
                            ...
                            <div class="banner-slide-item">
                                <figure class="banner-statistics">
                                    <a href="#">
                                        <img src="{{ asset('img/banner/img5-middle.jpg')  }}" alt="product banner">
                                    </a>
                                    <div class="banner-content banner-content_style2">
                                ...
                                <div class="group-list-carousel">
                                    ...
                                    <div class="group-slide-item">
                                        <div class="group-item">
                                            <div class="group-item-thumb">
                                                <a href="product-details.html">
                                                    <img src="{{ asset('img/product/product-15.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="group-item-desc">
                                                <h5 class="group-product-name"><a href="product-details.html">
                                ...
                                <div class="group-list-carousel">
                                    ...
                                    <div class="group-slide-item">
                                        <div class="group-item">
                                            <div class="group-item-thumb">
                                                <a href="product-details.html">
                                                    <img src="{{ asset('img/product/product-16.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="group-item-desc">
                                                <h5 class="group-product-name"><a href="product-details.html">
                                    ...
                                    <div class="group-slide-item">
                                        <div class="group-item">
                                            <div class="group-item-thumb">
                                                <a href="product-details.html">
                                                    <img src="{{ asset('img/product/product-18.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="group-item-desc">
                                                <h5 class="group-product-name"><a href="product-details.html">
